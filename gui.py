...
class AplikasiKantin:
    def __init__(self, root):
        self.root = root
        self.root.title("Kantin Kelompok XX")
        self.root.geometry("350x450")
        self.root.resizable(True, True)

        # --- 1. Judul / Header (Label) ---
        self.label_judul = tk.Label(root, text="Menu Kantin Mahasiswa", font=("Arial", 12, "bold"))
        ...
        self.btn_pesan = tk.Button(root, text="Hitung & Pesan", command=self.new_window, bg="lightblue", width=20)
        self.btn_pesan.pack(pady=20)

    def new_window(self):
        self.new_win = tk.Tk()
        self.new_win.title("Proses Pesanan")
